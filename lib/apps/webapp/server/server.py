...
from server.forest_info import Forest
import json
import pandas as pd
from flask import Flask, session, request, redirect, url_for, render_template
from flask_cors import CORS
from flask import send_from_directory
import server.tree_node_info as tree_node_info
import pyrebase
import json
from functools import wraps
from server.config_det import data_det
...
@app.route("/generate_surrogate_rules/", methods=['POST', 'GET'])
@check_token
def generate_surrogate_rules():
    ...
    forest.initialize(forest_obj.tree_node_dict, real_min, real_max, real_percentiles, df, y_pred, y_gt,
